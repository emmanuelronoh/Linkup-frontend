...
export default function SignIn() {
    ...
    useEffect(() => {
        document.title = "Sign In To LinkUp";
        return function () {
    ...
    async function handleSubmit(e) {
        ...
        setIsLoading(true);
        try {
            await login(formData, () => alert("Invalid Login Credentials"));
        } finally {
            setIsLoading(false);
        }
    }
    ...
    const loginAsDemo = async (e) => {
        ...
        try {
            ...
            await login(demoUser, () => alert("Invalid Login Credentials"));
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <main className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 text-center">
                    ...
                    <p className="mt-2 text-purple-100">Welcome back! Please sign in to continue</p>
                </div>
